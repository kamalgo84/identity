...
//			throw new WebApplicationException();
	...
	@Consumes("application/json")
	@Produces("application/json")
	public UserCardsResponse getUserCards(@Context HttpServletRequest request, @Context ServletContext servletContext) {
		...
		return dao.getUserCards((String)request.getSession().getAttribute(Constants.USER_ID));
	}
